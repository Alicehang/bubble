...
sched_sleep_on(ktqueue_t *q)
{
        ...
        dbg(DBG_PRINT, "GRADING1E: sched_sleep_on\n");
...
sched_cancellable_sleep_on(ktqueue_t *q)
{
        ...
        if(curthr->kt_cancelled)
                return -EINTR;
        dbg(DBG_PRINT, "GRADING1E: sched_cancellable_sleep_on\n");
...
sched_wakeup_on(ktqueue_t *q)
{
        ...
        dbg(DBG_PRINT, "GRADING1E: sched_wakeup_on\n");
        if(sched_queue_empty(q))
        {
                dbg(DBG_PRINT,"GRADING1E 22\n");
                return NULL;
        }
...
sched_cancel(struct kthread *kthr)
{
        /*NOT_YET_IMPLEMENTED("PROCS: sched_cancel");*/
         dbg(DBG_PRINT, "GRADING1E: sched_cancel\n");
        kthr->kt_cancelled=1;
        if(kthr->kt_state==KT_SLEEP_CANCELLABLE)
        {
                dbg(DBG_PRINT,"GRADING1E 23\n");
...
sched_switch(void)
{
        ...
        dbg(DBG_PRINT, "GRADING1E: sched_switch\n");
...
sched_make_runnable(kthread_t *thr)
{
        ...
        dbg(DBG_PRINT, "GRADING1E: sched_make_runnable\n");
